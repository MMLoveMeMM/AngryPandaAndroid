...
public class Okhttp1Thread extends Thread {

    private final static String TAG="Okhttp1Thread";
    ...
    public void run() {
        ...
        Interceptor interceptor=BasicInterceptor.getRequestHeader();
        //设置日志拦截器
        ...
        Call<ResponseBody> call = apiStores.getWeather("深圳","3a8c66214031c01135f509434ae44b84");// 参数在固定头部中
